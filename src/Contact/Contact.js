...
const Contact = () => {
    return (
        <div className="contact-container">
            <h2>Contact Me</h2>
            <p>Please feel free to reach out to me using the form below. Whether you're a recruiter, a potential
                collaborator, or just want to say hello, I'd love to hear from you!</p>
            <form>
